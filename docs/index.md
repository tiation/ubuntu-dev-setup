---
layout: default
title: Ubuntu Dev Setup - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Ubuntu Dev Setup</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/ubuntu-dev-setup" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
# Run container
docker run -p 8080:8080 ubuntu-dev-setup
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/ubuntu-dev-setup)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/ubuntu-dev-setup/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/ubuntu-dev-setup/discussions)
